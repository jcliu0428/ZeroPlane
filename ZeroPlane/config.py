...
def add_ZeroPlane_config(cfg):
    ...
    cfg.MODEL.MASK_FORMER.PREDICT_GLOBAL_PIXEL_DEPTH = False
    cfg.MODEL.MASK_FORMER.PREDICT_GLOBAL_PIXEL_NORMAL = False
    ...
    cfg.MODEL.MASK_FORMER.LEARN_NORMAL_CLS = False
    ...
    cfg.MODEL.MASK_FORMER.LEARN_OFFSET_CLS = False
    ...
    cfg.MODEL.MASK_FORMER.MIX_ANCHOR = False
    ...
    cfg.MODEL.MASK_FORMER.WITH_PIXEL_NORMAL_ATTENTION = False

    cfg.MODEL.MASK_FORMER.WITH_PIXEL_OFFSET_ATTENTION = False

    cfg.MODEL.MASK_FORMER.WITH_PIXEL_DEPTH_ATTENTION = False

    cfg.MODEL.MASK_FORMER.SEPARATE_PIXEL_ATTENTION = False
