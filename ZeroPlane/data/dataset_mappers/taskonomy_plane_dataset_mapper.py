...
__all__ = ['SingleTaskonomyPlaneDatasetMapper']
...
class SingleTaskonomyPlaneDatasetMapper():
    """
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "[TaskonomySinglePlaneDatasetMapper] Full TransformGens used in training: {}".format(
                str(self.tfm_gens)
            )
        )
